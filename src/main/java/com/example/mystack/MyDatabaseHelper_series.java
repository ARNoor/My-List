...
public class MyDatabaseHelper_series extends SQLiteOpenHelper {

    private static final String DATABASE_NAME = "MyStackS.db";
    private static final String TABLE_NAME = "SeriesTable";
    private static final int VERSION_NUMBER = 1;
    private static final String ID = "_id";
    private static final String RATING = "Rating";
    private static final String MOVIE_NAME = "Series_Name";
    private static final String GENRE = "Series_Genre";
    ...
    public MyDatabaseHelper_series(@Nullable Context context) {
