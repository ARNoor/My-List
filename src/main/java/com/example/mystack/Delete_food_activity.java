...
public class Delete_food_activity extends AppCompatActivity {
    private MyDatabaseHelper_foods myDatabaseHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        delete_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(Delete_food_activity.this, "Entry deleted, if it existed! :3", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
