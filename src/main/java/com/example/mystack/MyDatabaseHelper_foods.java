...
public class MyDatabaseHelper_foods extends SQLiteOpenHelper {

    private static final String DATABASE_NAME = "MyStackF.db";
    private static final String TABLE_NAME = "FoodsTable";
    private static final int VERSION_NUMBER = 1;
    private static final String ID = "_id";
    private static final String RATING = "Rating";
    private static final String MOVIE_NAME = "Food_Name";
    private static final String GENRE = "Restaurant_Name";
    private static final String GENRE2 = "Location_Name";
    ...
    public MyDatabaseHelper_foods(@Nullable Context context) {
    ...
    public long insertData(String name, String genre, String genre2, String suggested, String rating){
        SQLiteDatabase sqLiteDatabase = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(MOVIE_NAME, name);
        contentValues.put(GENRE, genre);
        contentValues.put(GENRE2, genre2);
